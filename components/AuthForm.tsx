  ...
  return (
    <div className="space-y-4 w-full max-w-sm">
      <button
        ...
        className="w-full pixel-font bg-white text-gray-800 hover:bg-gray-100 px-6 py-3 rounded-lg text-sm flex items-center justify-center gap-2"
      >
      ...
      <div className="flex items-center gap-2">
        ...
        <span className="pixel-font text-gray-500 text-xs">OR</span>
        <div className="flex-1 h-px bg-gray-700" />
      </div>
